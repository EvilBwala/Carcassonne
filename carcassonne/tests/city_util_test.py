...
class TestCityUtil(unittest.TestCase):
    ...
    def test_find_city(self):
        ...
        game_state.board = {(0, 0): city_bottom, (1, 0): city_top}
    ...
    def create_donut_city_board(self) -> CarcassonneGameState:
        ...
        game_state.board = {
            (0, 0): city_diagonal_bottom_right,
            (0, 1): city_narrow_left_right,
            (0, 2): city_diagonal_bottom_left,
            (1, 0): city_narrow_top_bottom,
            (1, 2): city_narrow_top_bottom,
            (2, 0): city_diagonal_top_right,
            (2, 1): city_narrow_left_right,
            (2, 2): city_diagonal_top_left,
        }
        return game_state
    ...
    def test_find_cities(self):
        ...
        game_state.board = {(0, 0): city_with_road, (0, 1): city_one_side_straight_road}
