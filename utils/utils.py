...
class CheckpointManager(object):
    ...
    def step(self, model, optimizer, step):
        ...
        save_optimizer(optimizer, checkpoint_path)
    ...
    def load(self, checkpoint_path, model, optimizer):
        ...
        model.load_state_dict(torch.load(os.path.join(checkpoint_path, 'model.pth')))
        load_optimizer(optimizer, checkpoint_path)
